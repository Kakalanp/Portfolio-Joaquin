const projects = [
  {
    img: './Images/ProjectSS/BookDev.png',
    title: 'BookDev',
    tags: ['React', 'Redux', 'Tailwind', 'Ruby on Rails', 'JavaScript', 'API'],
    live: 'https://book-dev.herokuapp.com/',
    source: 'https://github.com/awaisanwar544/final-capstone-ui',
    paragraph: "This is a web page that let's you make an appointment with a developer. This app makes use of API calls to its back-end API to get the data for everything regarding users, developers, and skills.",
  },
  {
  ...
  {
    img: './Images/ProjectSS/SuperCatMeowSquad.png',
    title: 'SCM Squad',
    tags: ['HTML', 'CSS', 'JavaScript', 'Webpack', 'API'],
    live: 'https://saadat123456.github.io/Amazing-Cats-2022/',
    source: 'https://github.com/Saadat123456/Amazing-Cats-2022',
    paragraph: 'This page dynamically displays the 6 members of the SCMS and contains some interactions with other users interested in them, like commenting on them or a like counter for each kitten.',
  },
  {
    img: './Images/ProjectSS/MultiversoDelRol.png',
    title: 'Multiverso del rol',
    tags: ['React', 'Modular CSS', 'JavaScript', 'Webpack', 'API'],
    live: '',
    source: 'https://github.com/Kakalanp/Multiverso-del-rol',
    paragraph: "This page dynamically displays different events from a Google Spreadsheet and adds links to create the event on your Google calendar or visit the organizer's Discord profile on a single click.",
  },
  {
    img: './Images/ProjectSS/AccountingKing.png',
    title: 'Accounting King',
    tags: ['HTML.erb', 'CSS', 'JavaScript', 'Ruby on Rails', 'Ruby', 'PostgreSql'],
    live: 'https://accountingking.herokuapp.com/',
    source: 'https://github.com/Kakalanp/accounting-king',
